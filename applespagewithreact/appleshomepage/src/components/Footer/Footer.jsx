    ...
    <footer>
      <div className="footer-head">
        <p className="footer-head-text">
          ...
          <span className="footer-head-text-link">
            <a href="index-mine.html">Full terms apply</a>
          </span>
          .
        </p>
      </div>
      <div className="footer-body-link-lists">
      ...
      <div className="footer-body-bottom">
        <div className="footer-body-bottom-1">
          <p className="footer-body-bottom-1-text">
            More ways to shop: <a href="#">Find an Apple Store</a> or
            <a href="#">other retailer</a> near you. Or call 1-800-MY-APPLE.
          </p>
        </div>
        <div className="footer-body-bottom-2">
          <div className="footer-body-bottom-2-copy">
            <p className="footer-body-bottom-2-copy-text">
              Copyright © 2019 Apple Inc. All rights reserved.
            </p>
          </div>
          <div className="footer-body-bottom-2-links">
            <ul className="footer-body-bottom-2-links-list">
              <li>
          ...
          <div className="footer-body-bottom-2-country">
            <p>
              <img
                className="flag"
                src={flag}
